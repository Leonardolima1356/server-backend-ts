...
routes.post("/lists", (req: Request, res: Response) : any => listController.create(req,res))
routes.get("/lists", (req: Request, res: Response) : any => listController.read(req,res))
routes.put("/lists/:id", (req: Request, res: Response) : any => listController.update(req,res))
routes.delete("/lists/:id", (req: Request, res: Response) : any => listController.delete(req,res))
